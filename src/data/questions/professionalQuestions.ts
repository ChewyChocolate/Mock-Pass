...
const PROFESSIONAL_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    topic: 'Verbal Ability',
    prompt:
      'Alin sa mga sumusunod ang halimbawa ng pokus sa tagatanggap (benefactive focus)?',
    options: [
      { id: 'A', text: 'Nagbasa ng libro si Maria kagabi.' },
      { id: 'B', text: 'Sumulat ng liham si Ana para sa kanyang ina.' },
      { id: 'C', text: 'Binigyan ng guro ng libro ang estudyante.' },
      { id: 'D', text: 'Pumunta sa paaralan ang bata kanina.' },
    ],
    correctOptionId: 'C',
    explanation:
      'Ang "binigyan" ay isang pandiwang benefactive; ang pokus (tagtuan ng pansin) ay ang tagatanggap na "ang estudyante." Ang A at D ay pokus sa tagaganap at layon; ang B ay pokus sa tagaganap na may sugnay na pang-abay.',
  },
  {
    id: 'q-122',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Tukuyin ang uri ng pang-abay sa pangungusap: "Kagabi ay pumunta kami sa palengke upang mamili ng mga gulay."',
    options: [
      { id: 'A', text: 'Pang-abay na pamaraan' },
      { id: 'B', text: 'Pang-abay na pamanahon' },
      { id: 'C', text: 'Pang-abay na pang-agam-agam' },
      { id: 'D', text: 'Pang-abay na pangkaantasan' },
    ],
    correctOptionId: 'B',
    explanation:
      'Ang "kagabi" ay tumutukoy sa oras o panahon ng pangyayari, kaya ito ay pang-abay na pamanahon. Ang "upang mamili" naman ay pang-abay na katwiran (dahilan).',
  },
  {
    id: 'q-123',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Piliin ang pangungusap na may wastong gamit ng panghalip panao at panghalip na pang-ari.',
    options: [
      { id: 'A', text: 'Siya at ako ay magkasama sa proyekto mula noong isang buwan.' },
      { id: 'B', text: 'Nagbigay si Ana ng regalo sa kaniya noong kaarawan niya.' },
      { id: 'C', text: 'Ibinigay ko kay Maria ang kaniyang libro kahapon.' },
      { id: 'D', text: 'Lahat ng nabanggit ay tama.' },
    ],
    correctOptionId: 'D',
    explanation:
      'Lahat ng mga pagpipilian ay tama. Sa A, tama ang paggamit ng "siya" at "ako" bilang paksa. Sa B, tama ang "kaniya" bilang tagatanggap at "niya" bilang pang-ari. Sa C, tama ang "ko" (nagmamay-ari, unang panauhan) at "kaniyang" (pang-ari ni Maria).',
  },
  {
    id: 'q-124',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Ayusin ang mga pangungusap sa tamang pagkakasunod-sunod ng lohikal na pangyayari: (1) Pumunta siya sa palengke. (2) Nagluto siya ng hapunan. (3) Bumili siya ng mga sariwang sangkap. (4) Kinain ng buong pamilya ang pagkain nang sabay-sabay.',
    options: [
      { id: 'A', text: '1 – 2 – 3 – 4' },
      { id: 'B', text: '1 – 3 – 2 – 4' },
      { id: 'C', text: '2 – 1 – 3 – 4' },
    ...
    correctOptionId: 'B',
    explanation:
      'Ang tamang pagkakasunod-sunod ng lohikal na pangyayari ay: pumunta sa palengke (1) → bumili ng sangkap (3) → nagluto ng hapunan (2) → kinain ng pamilya (4).',
  },
  {
    id: 'q-125',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Basahin ang talata: "Ang pagbasa ay isang kasanayang nagpapalawak ng isipan. Sa pamamagitan ng pagbasa, natututo tayo ng mga bagong salita at ideya. Nakakatulong din ito sa pagpapabuti ng konsentrasyon at memorya. Bukod dito, ang pagbasa ay isang mahusay na paraan upang magpahinga at mabawasan ang stress." Alin ang paksa (topic sentence) ng talata?',
    options: [
      { id: 'A', text: 'Ang pagbasa ay isang kasanayang nagpapalawak ng isipan.' },
      { id: 'B', text: 'Sa pamamagitan ng pagbasa, natututo tayo ng mga bagong salita at ideya.' },
      { id: 'C', text: 'Nakakatulong din ito sa pagpapabuti ng konsentrasyon at memorya.' },
      { id: 'D', text: 'Ang pagbasa ay isang mahusay na paraan upang magpahinga at mabawasan ang stress.' },
    ],
    correctOptionId: 'A',
    explanation:
      'Ang topic sentence ay nagsasaad ng pangunahing ideya ng talata. Sa kasong ito, ang unang pangungusap ang nagpapahayag na ang pagbasa ay nagpapalawak ng isipan, at ang mga sumusunod ay nagbibigay ng mga pansuportang detalye.',
  },
  {
    id: 'q-126',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Piliin ang pinakamahusay na transitional phrase upang ikonekta ang dalawang pangungusap: "Marami ang naging epekto ng climate change sa ating bansa. _____, tumaas ang antas ng dagat sa maraming coastal areas sa nakalipas na dekada."',
    options: [
      { id: 'A', text: 'Sa kabilang banda' },
      { id: 'B', text: 'Halimbawa' },
      { id: 'C', text: 'Bilang isang resulta' },
      { id: 'D', text: 'Sa kabaligtaran' },
    ],
    correctOptionId: 'C',
    explanation:
      'Ang "bilang isang resulta" ay nagpapahayag ng sanhi at bunga (cause-and-effect), na siyang angkop na ugnayan sa pagitan ng dalawang pangungusap. Ang "sa kabilang banda" at "sa kabaligtaran" ay nagpapahayag ng paghahambing o kontra, habang ang "halimbawa" ay nagpapakilala ng partikular na kaso.',
  },
  {
    id: 'q-127',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Basahin ang talata: "Ang pamilyang Pilipino ay kilala sa malapit na pagkakaisa at pagtutulungan. Kahit na nahaharap sa mga pagsubok, nananatiling matatag ang kanilang pagmamahalan. Ipinagdiriwang nila ang mga pista at okasyon bilang isang pagkakataon upang palakasin ang kanilang ugnayan. Ang tradisyong ito ay nagpapakita ng kahalagahan ng pamilya sa kulturang Pilipino." Ano ang pangunahing ideya ng talata?',
    options: [
      { id: 'A', text: 'Mahirap ang buhay ng pamilyang Pilipino sa kasalukuyan.' },
      { id: 'B', text: 'Ang pamilyang Pilipino ay nagkakaisa at nagtutulungan sa kabila ng mga pagsubok.' },
      { id: 'C', text: 'Mahalaga ang mga pista at okasyon sa buhay ng bawat pamilya.' },
      { id: 'D', text: 'Mayaman at sinauna ang kulturang Pilipino.' },
    ],
    correctOptionId: 'B',
    explanation:
      'Ang buong talata ay nakatuon sa pagkakaisa, pagtutulungan, at pagmamahalan ng pamilyang Pilipino. Ang mga pista at okasyon ay binanggit bilang isang paraan upang palakasin ang kanilang ugnayan, hindi bilang pangunahing paksa.',
  },
  {
    id: 'q-128',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Basahin ang talata: "Ayon sa pag-aaral ng Department of Health noong 2023, tumaas ang bilang ng mga nagpapabakuna laban sa trangkaso sa mga nakaraang taon. Kasabay nito, maraming ospital ang nag-ulat ng mas kaunting admissions para sa respiratory illnesses. Gayunpaman, payo pa rin ng mga eksperto na mag-ingat lalo na sa panahon ng tag-ulan at magpatuloy sa mga health protocols." Ano ang maaaring i-infer mula sa talata?',
    options: [
      { id: 'A', text: 'Hindi na kailangan ang mga bakuna laban sa trangkaso.' },
      { id: 'B', text: 'Ang pagpapabakuna ay maaaring makatulong sa pagpapababa ng kaso ng respiratory illnesses.' },
      { id: 'C', text: 'Hindi na kailangan mag-ingat ngayong panahon ng tag-ulan.' },
      { id: 'D', text: 'Hindi na epektibo ang mga health protocols laban sa sakit.' },
    ],
    correctOptionId: 'B',
    explanation:
      'Ipinapakita ng datos na sabay na tumaas ang bilang ng mga nagpapabakuna AT bumaba ang bilang ng admissions. Ang lohikal na inference ay maaaring may kaugnayan ang dalawang pangyayaring ito, bagama\'t hindi nito nagsasabing garantisado ang causality.',
  },
  {
    id: 'q-129',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Basahin ang pangungusap: "Sa kabila ng matinding unos, nagpatuloy ang mga magsasaka sa pagtatanim ng palay. Ang kanilang katatagan at pagmamahal sa lupa ang nagbigay-inspirasyon sa buong barangay." Ano ang kahulugan ng salitang "katatagan" batay sa konteksto ng pangungusap?',
    options: [
      { id: 'A', text: 'Kahinaan ng loob' },
      { id: 'B', text: 'Katigasan ng ulo at pagmamatigas' },
      { id: 'C', text: 'Lakas ng loob at pagtitiyaga sa kabila ng pagsubok' },
      { id: 'D', text: 'Pag-aalinlangan at takot sa mga hamon' },
    ],
    correctOptionId: 'C',
    explanation:
      'Sa kontekstong "sa kabila ng matinding unos, nagpatuloy...," ang "katatagan" ay tumutukoy sa lakas ng loob at pagtitiyaga upang harapin at magpatuloy sa kabila ng mga pagsubok. Ito ay isang positibong katangian ng katatagan ng loob.',
  },
  {
    id: 'q-130',
    level: 'professional',
    topic: 'Verbal Ability',
    prompt:
      'Basahin ang talata: "Ang Bayanihan ay isang tradisyong Pilipino kung saan ang mga kapitbahay ay nagtutulungan sa paglilipat ng bahay o kaya\'y pagtulong sa may bahay-bahay na nangangailangan. Sa modernong panahon, ang diwa ng bayanihan ay makikita pa rin sa mga komunidad tuwing may kalamidad. Maraming organisasyon ang naglilikom ng donasyon at nagpapakain sa mga biktima ng bagyo at iba pang sakuna." Alin sa mga sumusunod ang HINDI binanggit sa talata?',
    options: [
      { id: 'A', text: 'Ang bayanihan ay isang tradisyong Pilipino na kasalukuyang isinasabuhay.' },
      { id: 'B', text: 'Ang mga organisasyon ay tumutulong din sa mga biktima ng kalamidad.' },
      { id: 'C', text: 'Ang bayanihan ay tumutulong sa pagtatayo ng mga bagong gusali at imprastraktura.' },
      { id: 'D', text: 'Ang diwa ng bayanihan ay makikita pa rin sa modernong panahon.' },
    ],
    correctOptionId: 'C',
    explanation:
      'Hindi binanggit sa talata ang tungkol sa pagtatayo ng mga bagong gusali o imprastraktura. Ang talata ay tumatalakay sa pagtutulungan sa paglilipat ng bahay at pagtulong tuwing may kalamidad, hindi sa konstruksyon ng mga bagong gusali.',
  },
  {
    id: 'q-131',
    level: 'professional',
